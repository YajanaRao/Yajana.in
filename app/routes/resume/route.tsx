    ...
    <Prose>
      <div className="min-h-screen p-1 md:p-6">
        <div className="mx-auto max-w-4xl bg-card p-8">
          <h1 className="font-heading text-4xl font-extrabold text-ink-primary">
            Yajana N Rao
          </h1>
          <p className="text-ink-secondary my-0">Phone: +91 7022085575</p>
          <p className="text-ink-secondary my-0">
            Email:{" "}
            <a href="mailto:yajananrao@gmail.com" className="text-primary">
              yajananrao@gmail.com
            </a>
          </p>
          <p className="text-ink-secondary my-0">Address: Karnataka, India</p>
          <p className="text-ink-secondary my-0">
            GitHub:{" "}
          ...
          <h2 className="mt-4 font-heading text-2xl font-extrabold text-ink-primary">
            Summary
          </h2>
            <p className="text-ink-secondary mb-0">
              Focused and quick-learning Software Engineer with 7+ years of
              experience in building applications for various problem
              statements.
            </p>
          </section>

          <section className="mt-4">
            <h2 className="mt-4 font-heading text-2xl font-extrabold text-ink-primary">Skills</h2>
            <ul className="list-disc ml-4 text-ink-secondary mb-0">
              <li className="my-0">
              ...
              <li className="my-0">
                <b className="font-bold">Other commonly Tools:</b> Figma,
                Webpack, Vite, Sentry, Google Analytics, Microsoft Clarity,
                XCode, Android Studio, Expo EAS, Github actions, JIRA, AWS
              </li>
            </ul>
          </section>
          ...
          <section className="mt-4">
            ...
            <div>
              ...
              <ul className="list-disc ml-4 text-ink-secondary mb-0">
                ...
                <li className="my-0">
                  Interactpitch achieved #1 Product of the Day on Product Hunt
                  at launch.
                </li>
                <li className="my-0">
            ...
            <div>
              <h3 className="font-semibold text-ink-primary">
                ...
                <a href="https://mammoth.io">Mammoth Analytics</a> (Jul 2023 -
                Jun 2025)
              </h3>
              <ul className="list-disc ml-4 text-ink-secondary mb-0">
                <li className="my-0">
                  Contributed to migrating legacy angularJS application into
                  VueJS incrementally.
                </li>
                <li className="my-0">
                  Created architecture required for scaling frontend application
                  using Vite, Vuex and vue-i18n for bundling, state management
            ...
            <div>
              ...
              <ul className="list-disc ml-4 text-ink-secondary mb-0">
                ...
                <li className="my-0">
                  Setup Vuex and Vuex Persisting to improve frontend
                  performance.
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="list-disc ml-4 text-ink-secondary mb-0">
                <li className="my-0">
                  Developed Facial detection project using ReactJS, Flask,
                  OpenCV, TensorFlow and Elasticsearch
                </li>
                <li className="my-0">
          ...
          <section className="mt-4">
            <h2 className="mt-4 font-heading text-2xl font-extrabold text-ink-primary">Projects</h2>
            <div>
              <h3 className="font-semibold text-ink-primary">
            ...
            <div>
              ...
              <ul className="list-disc ml-4 text-ink-secondary mb-0">
                <li className="my-0">
                  NPM package for Cross Platform music player for android ios
                  and web.
                </li>
                <li className="my-0">
                  Built using java, swift, and typescript.
                </li>
              </ul>
            </div>
          ...
          <section className="mt-4">
            <h2 className="mt-4 font-heading text-2xl font-extrabold text-ink-primary">Education</h2>
            <ul className="list-disc ml-4 text-ink-secondary mb-0">
              <li className="text-ink-secondary my-0">
